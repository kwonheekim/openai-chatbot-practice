...
OpenAI API 키는 [여기](https://platform.openai.com/api-keys)에서 발급받을 수 있습니다.
...
- GPT-3.5-turbo: 저렴하고 빠름
- GPT-4: 더 강력하지만 비용이 높음

[OpenAI Pricing](https://openai.com/pricing)에서 자세한 요금을 확인하세요.

## 🔒 보안 주의사항

- ⚠️ `.env` 파일은 절대 Git에 커밋하지 마세요
- ⚠️ API 키는 백엔드에만 저장하세요 (프론트엔드 노출 금지)
- ⚠️ 실제 배포 시에는 환경 변수를 안전하게 관리하세요
